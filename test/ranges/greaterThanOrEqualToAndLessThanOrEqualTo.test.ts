...
describe.skip('SemVer \'Greater Than Or Equal To And Less Than Or Equal To\' Range (>= <=): tests', function () {
  ...
  context(' >= <= ', function () {
    ...
    it('',
      async function () {
        packageJson.dependencies[packageName] = '>=8.x <=9';
        const result = await resolver.resolve(packageJson);
        expect(result.dependencies[packageName]).to.be.equal('^9.4.6');
      });
    ...
    it('',
      async function () {
        packageJson.dependencies[packageName] = '>=8.5.x <=9';
        const result = await resolver.resolve(packageJson);
        expect(result.dependencies[packageName]).to.be.equal('^9.4.6');
      });
    ...
    it('',
      async function () {
        packageJson.dependencies[packageName] = '>=7.2.0 <=9';
        const result = await resolver.resolve(packageJson);
        expect(result.dependencies[packageName]).to.be.equal('^9.4.6');
      });
    ...
    it('',
      async function () {
        packageJson.dependencies[packageName] = '>=8.2.0 <=9';
        const result = await resolver.resolve(packageJson);
        expect(result.dependencies[packageName]).to.be.equal('^9.4.6');
      });
    ...
    it('',
      async function () {
        packageJson.dependencies[packageName] = '>=7.5.1 <=9';
        const result = await resolver.resolve(packageJson);
        expect(result.dependencies[packageName]).to.be.equal('^9.4.6');
      });
    ...
    it('',
      async function () {
        packageJson.dependencies[packageName] = '>=8.5.4 <=9';
        const result = await resolver.resolve(packageJson);
        expect(result.dependencies[packageName]).to.be.equal('^9.4.6');
      });
